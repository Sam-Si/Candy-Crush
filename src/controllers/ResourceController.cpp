...
bool ResourceController::loadResources()
{
	...
	// Load background
	resourceMap["background"] = loadTexture("assets/images/BackGround.jpg", 30, 30, 30, 755, 600);

	// Load game objects with string identifiers
	struct { const char* id; Uint8 r, g, b; const char* path; } objects[] = {
		{ "blue", 0, 0, 255, "assets/images/Blue.png" },
		{ "green", 0, 255, 0, "assets/images/Green.png" },
		{ "purple", 128, 0, 128, "assets/images/Purple.png" },
		{ "red", 255, 0, 0, "assets/images/Red.png" },
		{ "yellow", 255, 255, 0, "assets/images/Yellow.png" }
	};
